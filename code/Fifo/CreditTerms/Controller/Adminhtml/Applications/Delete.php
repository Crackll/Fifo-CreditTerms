...
class Delete extends \Fifo\CreditTerms\Controller\Adminhtml\Applications
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $this->messageManager->addError(
                    __('We can\'t delete credit term application right now. Please review the log and try again.')
                );
        ...
        $this->messageManager->addError(__('We can\'t find a credit term application to delete.'));
        $this->_redirect('fifo_creditterms/*/');
    }
}
