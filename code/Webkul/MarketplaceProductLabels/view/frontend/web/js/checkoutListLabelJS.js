...
define(
    ...
    function ($,$t) {
            ...
            'webkul.checkoutListLabelJS',
            {
                _create: function () {
                    ...
                    $(".cart .item").each(function (index,element) {
                        ...
                        var id2 = [];
                        var id = $(this).find(".item-actions").find(".action-edit").attr('href');
                        if (id) {
                            var id1 = id.split('product_id');
                            id2 = id1[1].split('/');
                            var self1 = this;
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $($(self1).find(".item-info").find(".col").find("a").find("span").find("span")).prepend(img);
                                }
                            })
                        }
                    });
        ...
        return $.webkul.checkoutListLabelJS;
    }
);