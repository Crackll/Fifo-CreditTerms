...
define([
    ...
    $.widget('mage.priceBox', {
        ...
        reloadPrice: function reDrawPrices()
        {
            ...
            $('[id^=deal]').each(function (index, value) {
                if (!$(this).hasClass('max-deal-amount')) {
                    $(this).css('display','none');
                } 
            });
            if (selectedProduct) {
                $('.max-deal-amount').css('display','none');
                $('#max-save-deal').css('display','none');
                $('#deal'+selectedProduct).css('display','block');
            } 
        },
