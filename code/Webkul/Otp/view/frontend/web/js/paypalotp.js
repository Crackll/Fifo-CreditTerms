    ...
    'domReady!',
        ...
        return Component.extend({
            ...
            initialize: function(options, element) {
                ...
                paypalOtpText.on('click', function(event) {
                    $('body').trigger('click');
                ...
                guestDetailsContainerSubmitBtn.click(function(event) {
                    event.preventDefault();
                ...
                otpContainerSubmitBtn.click(function(event) {
                    event.preventDefault();
                ...
                // OTP Keydown event
                otpContainerInput.keydown(function(e) {
