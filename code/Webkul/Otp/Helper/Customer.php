...
class Customer extends AbstractHelper
{
    ...
    const USERNAME_PHONE_NUMBER = 'phonenumber';
    const USERNAME_BOTH = 'both';
    ...
    const PHONENUMBER_ALREADY_EXISTS = 'phonenumber_already_exists';
    const PHONENUMBER_INVALID_FORMAT = 'phonenumber_invalid_format';
    const PHONENUMBER_VALIDATION_SUCCESS = 'phonenumber_validation_success';
