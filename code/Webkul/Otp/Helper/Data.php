...
{
    const XML_PATH_MODULE_ENABLE = 'otp/enable/otp_enable';
    const XML_PATH_ONESTEPCHECKOUT_ENABLE = 'opc/general_settings/active';
    const XML_PATH_MODULE_ENABLE_REGISTRATION = 'otp/enable/otp_enable_registration';
    const XML_PATH_REGISTRATION_EMAIL = 'otp/emailsettings/otp_notification';
    const XML_PATH_MODULE_ENABLE_CHECKOUT = 'otp/enable/otp_enable_checkout';
    const XML_PATH_ALLOWED_PAYMENT_METHODS = 'otp/enable/allowed_payment_methods';
    const XML_PATH_CHECKOUT_EMAIL = 'otp/emailsettings/otp_checkout_notification';
    const XML_PATH_MODULE_ENABLED_FORGOT_PASSWORD = 'otp/enable/forgot_password';
    const TWILLO_AUTH_ID = 'otp/twiliosettings/authId';
    const TWILLO_TOKEN = 'otp/twiliosettings/token';
    const TWILIO_OTP_MESSAGE = 'otp/twiliosettings/message';
    const TWILIO_ENABLED = 'otp/twiliosettings/twillo_auth_enabled';
    const TWILIO_SEND_OTP_EMAIL_ENABLED = 'otp/twiliosettings/send_otp_email_enabled';
    const SENDER_NUMBER = 'otp/twiliosettings/number';
    const OTP_EXPIRY = 'otp/enable/expiry';
    const SEND_OTP_VIA = 'otp/twiliosettings/send_otp_via';
    ...
    public function getCountries($refresh = false): array
    {
        if (empty($this->countries) || $refresh) {
            try {
                $url = 'restcountries.eu/rest/v2/all?fields=name;callingCodes';
    ...
    {
        try {
            $url = "restcountries.eu/rest/v2/alpha/$countryCode?fields=callingCodes";
    ...
    public function getOtpModalConfig(): array
    {
        ...
        $otpModalConfig = [
            ...
            'otpTimeToExpireMessage' => __("Your OTP will expire in $otpTimeToExpireString."),
