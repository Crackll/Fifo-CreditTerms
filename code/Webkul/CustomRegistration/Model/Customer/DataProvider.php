...
class DataProvider extends \Magento\Customer\Model\Customer\DataProvider
{
    ...
    */
    ...
    protected function getAttributesMeta(Type $entityType)
    {
        ...
        $this->_regHelper = $this->_regHelper ?: ObjectManager::getInstance()->get(
            \Webkul\CustomRegistration\Helper\Order::class
        );
    ...
    {
        $this->context =  $this->context ?: ObjectManager::getInstance()->get(ContextInterface::class);
