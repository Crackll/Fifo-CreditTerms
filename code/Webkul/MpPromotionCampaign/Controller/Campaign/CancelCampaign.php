...
class CancelCampaign extends \Magento\Customer\Controller\AbstractAccount implements CsrfAwareActionInterface
{
    /**
     * Result Page
     *
    ...
    public function execute()
    {
        ...
        if ($this->marketplaceHelper->isSeller()) {
            ...
            if ($joinCampaign->getId()) {
                $joinCampaign->delete();
                $this->messageManager->addSuccess(__('You successfully cancel this campaign.'));
            }
