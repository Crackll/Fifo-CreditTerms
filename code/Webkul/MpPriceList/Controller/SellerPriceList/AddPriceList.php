...
class AddPriceList extends \Magento\Customer\Controller\AbstractAccount
{
    /**
     * @var PageFactory
     */
        ...
        if ($isPartner == 1) {
            if ($this->_pricelistHelper->isModuleEnabled()) {
                ...
                if ($this->mpHelper->getIsSeparatePanel()) {
                    $resultPage->addHandle('mppricelist_sellerpricelist_addpricelist_layout2');
                }
                $resultPage->getConfig()->getTitle()->set(__('Add Price List'));
                return $resultPage;
            } else {
