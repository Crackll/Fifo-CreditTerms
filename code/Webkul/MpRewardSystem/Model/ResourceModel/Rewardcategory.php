...
class Rewardcategory extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('wk_mp_reward_category', 'entity_id');
    }
    ...
    {
        return $this->metadataPool->getMetadata(RewardcategoryInterface::class)->getEntityConnection();
    }
     ...
     * @throws \Exception
     */
    protected function getRewardCategoryById(AbstractModel $object, $value, $field = null)
    {
        $entityMetadata = $this->metadataPool->getMetadata(RewardcategoryInterface::class);
