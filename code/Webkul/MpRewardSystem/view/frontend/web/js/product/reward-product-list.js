...
define([
    ...
    'mage/calendar'
        ...
        return Component.extend({
            ...
            var localStorageArray = localStorage.getItem("checkedDataProduct");
            if (localStorageArray != undefined || localStorageArray != null) {
                ...
                if (dateDiff > 120) {
                    localStorage.removeItem("checkedDataProduct");
            ...
            $('body').on('click', '.mpcheckbox', function (e) {
                if (this.checked === true) {
                    ...
                    localStorage.setItem("checkedDataProduct", JSON.stringify(checkBoxArray));
                }
            ...
            $('body').on('click', '#limiter', function (e) {
                ...
                $('body').delegate('#mass-assign-butn','click', function (e) {
                    ...
                    if (flag === 0) {
                        ...
                        var dicisionapp=confirm($t(" Are you sure you want to assign rewards to these product ? "));
                        if (dicisionapp === true) {
