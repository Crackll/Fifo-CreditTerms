 ...
 */
class Agentlist extends AgentCollection implements ApiSearchResultInterface
{
    /**
    ...
    {
        $this->addFilterToMap('agent_id', 'au.user_id');
        $this->addFilterToMap('firstname', 'au.firstname');
        $this->addFilterToMap('lastname', 'au.lastname');
        $this->addFilterToMap('email', 'au.email');
        parent::_initSelect();
    }
}
