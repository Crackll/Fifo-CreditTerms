 ...
 */
namespace Webkul\Helpdesk\Model\ResourceModel\Customer\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as ApiSearchResultInterface;
use Webkul\Helpdesk\Model\ResourceModel\Customer\Collection as CustomerCollection;
...
/**
 * Webkul\Helpdesk\Model\ResourceModel\Customer\Grid\Collection Class
 * Collection for displaying grid of Helpdesk Customer.
 */
class Collection extends CustomerCollection implements ApiSearchResultInterface
{
    /**
    ...
    {
        $joinTable2 = $this->getTable('helpdesk_customer_organization');
        $this->getSelect()->joinleft(
            $joinTable2.' as hco',
            'main_table.organizations = hco.entity_id',
            [
               'org_name' => 'hco.name'
            ]
        );
