 ...
 */
namespace Webkul\Helpdesk\Model\ResourceModel\TicketsCustomAttributes\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as ApiSearchResultInterface;
use Webkul\Helpdesk\Model\ResourceModel\TicketsCustomAttributes\Collection as TicketsCustomAttributesCollection;
...
/**
 * Webkul\Helpdesk\Model\ResourceModel\TicketsCustomAttributes\Grid\Collection Class
 * Collection for displaying grid of Helpdesk TicketsCustomAttributes.
 */
class Collection extends TicketsCustomAttributesCollection implements ApiSearchResultInterface
{
    /**
    ...
    {
        $joinTable = $this->getTable('eav_attribute');
        $this->getSelect()->join(
            $joinTable.' as ea',
