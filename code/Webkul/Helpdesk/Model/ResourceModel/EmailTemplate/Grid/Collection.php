 ...
 */
namespace Webkul\Helpdesk\Model\ResourceModel\EmailTemplate\Grid;

use Magento\Framework\Api\Search\SearchResultInterface as ApiSearchResultInterface;
use Webkul\Helpdesk\Model\ResourceModel\EmailTemplate\Collection as EmailTemplateCollection;
...
/**
 * Webkul\Helpdesk\Model\ResourceModel\EmailTemplate\Grid\Collection Class
 * Collection for displaying grid of Helpdesk EmailTemplate.
 */
class Collection extends EmailTemplateCollection implements ApiSearchResultInterface
{
    /**
    ...
    {
        $joinTable2 = $this->getTable('email_template');
        $this->getSelect()->join(
            $joinTable2.' as et',
