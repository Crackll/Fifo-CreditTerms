...
class PriceRule extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('mpwholesale_price_rules', 'entity_id');
    }
    ...
    {
        return $this->metadataPool->getMetadata(PriceRuleInterface::class)->getEntityConnection();
    }
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(PriceRuleInterface::class);
