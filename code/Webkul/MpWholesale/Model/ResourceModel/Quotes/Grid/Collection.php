...
namespace Webkul\MpWholesale\Model\ResourceModel\Quotes\Grid;

use Webkul\MpWholesale\Model\ResourceModel\Quotes\Collection as WholeSalerQuotesCollection;
use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Magento\Backend\Model\Auth\Session;

class Collection extends WholeSalerQuotesCollection implements SearchResultInterface
{
    /**
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->where(
            'main_table.wholesaler_id ='.$userId
        );
