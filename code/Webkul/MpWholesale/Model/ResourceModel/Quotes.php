...
class Quotes extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('wholesaler_quotes', 'entity_id');
    }
    ...
    {
        return $this->metadataPool->getMetadata(QuoteInterface::class)->getEntityConnection();
    }
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(QuoteInterface::class);
