    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('Price From'),
                'required' => true,
                'class' => 'validate-greater-than-zero required-entry validate-number validate-not-negative-number '
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'title' => __('Price To'),
                'required' => true,
                'class' => 'validate-greater-than-zero required-entry validate-not-negative-number validate-number'.
