            ...
            try {
                ...
                if (!$existingRuleId || $existingRuleId == $ruleId) {
                    ...
                    if ($ruleId) {
                        ...
                        $data["created_at"] = $commissionRules->getCreatedAt();
                    ...
                    $commissionRules = $this->_commissionRulesFactory->create()->load($ruleId);
                    $commissionRules->setCreatedAt($data["created_at"])->save();
