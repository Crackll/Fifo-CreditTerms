/**
 * Webkul_MpAuction Wishlist View Js
 * @category  Webkul
        ...
        _create: function () {
            ...
            $('.auction, .buy-it-now').each(function () {
                if ($(this).hasClass('auction')) {
                    ...
                    var link = $(this).parents('.product-item-info').find('a.product-item-link').attr('href');
                ...
                if ($(this).hasClass('buy-it-now') && $(this).attr('data-winner') != 0) {
                    thisParent.find('.tocart.primary span').text(viewProductOpt.buyItNow);
                    ...
                    var viewDetail = $('<a />').attr('title', viewProductOpt.viewDetail)
                                                .attr('href', proLink)
                                                .addClass('action primary auto-bid-show')
                                                .append($('<span />').text(viewProductOpt.viewDetail));
            ...
            $('.action.tocart').on('click', function () {
                ...
                if ($(this).parents('.product-item-info').find('.buy-it-now').length) {
                    setTimeout(function () {
                        thiscart.text(viewProductOpt.buyItNow);
                    }, 2000);
                } else {
