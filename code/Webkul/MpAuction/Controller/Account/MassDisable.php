    ...
    public function execute()
    {
        ...
        if ($data && isset($data['auction_mass_disable'])) {
            ...
            foreach ($mpAucProList as $mpAucPro) {
                ...
                if ((
                        $mpAucPro->getAuctionStatus() == 0
                        || $mpAucPro->getAuctionStatus() == 1
                        || $mpAucPro->getAuctionStatus() == 2
                    )
                     && $isSeller
                    ) {
            ...
            $this->messageManager->addSuccess(
                __('A total of %1 record(s) have been canceled successfully.', $recordCancel)
            );
        } else {
