    ...
    protected function _prepareForm()
    {
        ...
        if ($model->getEntityId()) {
            $model->setStartAuctionTime(
                date_format(date_create($this->converToTz($model->getStartAuctionTime())), 'm/d/y H:i:s')
            );
            $model->setStopAuctionTime(
                date_format(date_create($this->converToTz($model->getStopAuctionTime())), 'm/d/y H:i:s')
            );
            ...
            $fieldset->addField('url', 'hidden', ['name' => 'wkmp_url']);
        }
        if ($model->getEntityId()) {
        ...
        if ($model->getType()=="downloadable") {
            $fieldset->addField('min_qty', 'hidden', ['name' => 'min_qty']);
            $fieldset->addField('max_qty', 'hidden', ['name' => 'max_qty']);
        } elseif ($model->getType()!="downloadable") {
            $fieldset->addField(
                'min_qty',
                'text',
                [
        ...
        $model->setUrl($this->getUrl('mpauction/auction/disable'));
