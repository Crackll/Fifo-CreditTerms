...
namespace Webkul\CustomerSubaccount\Controller\SubaccountOrder;
...
class Index extends \Magento\Customer\Controller\AbstractAccount
{
    ...
    public function execute()
    {
        ...
        if (!$this->helper->canViewSubAccountOrderList($customerId)) {
            throw new NotFoundException(__('Action Not Allowed.'));
        }
        $resultPage = $this->_resultPageFactory->create();
        $pageLabel = "";
        $resultPage->getConfig()->getTitle()->set(__('Sub Account Orders'));
