...
namespace Webkul\CustomerSubaccount\Controller\Quote;
...
class Index extends \Magento\Customer\Controller\AbstractAccount
{
    ...
    {
        if (!$this->getRequest()->getParam('isAjax') || !$this->getRequest()->getParam('id')) {
            throw new NotFoundException(__('Action Not Allowed.'));
        }
        $resultPage = $this->_resultPageFactory->create();
        $pageLabel = "";
        $resultPage->getConfig()->getTitle()->set(__('Quote Data'));
