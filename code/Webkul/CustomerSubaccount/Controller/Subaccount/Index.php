...
class Index extends \Magento\Customer\Controller\AbstractAccount
{
    ...
    public function execute()
    {
        if (!
            (
                $this->helper->canCreateSubAccounts() ||
                $this->helper->canEditSubAccounts() ||
                $this->helper->canDeleteSubAccounts() ||
                $this->helper->canLoginToSubAccounts()
            )
        ) {
        ...
        $pageLabel = "";
        $resultPage->getConfig()->getTitle()->set(__('Manage Sub Accounts'));
