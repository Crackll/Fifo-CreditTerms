<?php
namespace Webkul\CustomerSubaccount\Block\SubaccountOrder;
...
class History extends \Magento\Sales\Block\Order\History
{
    ...
    public function getOrders()
    {
        ...
        if (!$this->orders) {
            ...
            $this->orders = $this->getOrderCollectionFactory()->create($subAccountIds)->addFieldToSelect(
                '*'
            )->addFieldToFilter(
                'status',
    ...
    {
        if ($this->helper->canViewSubAccountOrderDetails()) {
            return true;
        }
        return false;
    }
