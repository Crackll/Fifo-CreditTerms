...
class CustomerTab extends Generic implements TabInterface
{
        ...
        foreach ($attributes as $attribute) {
            switch ($attribute->getFrontendInput()) {
                ...
                case "date":
                    ...
                    $fieldset->addField(
                        ...
                        [
                            ...
                            'label' => $attribute->getFrontendLabel(),
                            'title' => $attribute->getFrontendLabel(),
                            'value' => $this->formatDate($value, \IntlDateFormatter::SHORT, false),
                            'required' => $this->isAttributeRequired($attribute->getId()),
                ...
                case "image":
                    ...
                    $field = "'customfields_your_image_image'";
                    $fieldset->addField(
                        $attribute->getAttributeCode(),
                        'file',
                        [
                            ...
                            'after_element_html' => ($value != '' && $value != 1) ?
                                '<script>
                                    ...
                                    let tempCode = "'.$attribute->getAttributeCode().'";
                                    imageCode.push(tempCode);

                                    </script><a href='.$url.'"
                                    onclick="imagePreview('.$field.'); return false;">
                            <img src='.$url.'
    ...
    public function isWysiwygEnabled($attribute)
    {
        ...
        $classes = explode(" ", $attribute->getFrontendClass());
        $type = "textarea";
