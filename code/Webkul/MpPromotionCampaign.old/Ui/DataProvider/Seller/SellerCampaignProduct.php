...
class SellerCampaignProduct extends \Magento\Catalog\Ui\DataProvider\Product\ProductDataProvider
{
    /**
     * Product collection
     *
    ...
    public function addFilter(\Magento\Framework\Api\Filter $filter)
    {
        if ($filter->getField()!='camprice') {
            ...
            $campaignPriceFrom = $data['filters']['camprice']['from'];
            $campaignPriceTo = $data['filters']['camprice']['to'];
