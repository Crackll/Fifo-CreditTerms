...
namespace Webkul\MpWalletSystem\Block\Adminhtml\Creditrules;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        if ($this->_isAllowedAction('Webkul_MpWalletSystem::walletcreditrules')) {
        ...
        if ($this->_isAllowedAction('Webkul_MpWalletSystem::delete')) {
    ...
    {
        $codRegistry = $this->coreRegistry->registry('cod_pricerates');
