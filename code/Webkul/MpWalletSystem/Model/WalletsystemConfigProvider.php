...
class WalletsystemConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $config['payment']['mpwalletsystem']['loaderimage'] = $image;
        $config['payment']['mpwalletsystem']['getcurrentcode'] = $getcurrentcode;
        $config['payment']['mpwalletsystem']['walletformatamount'] = $walletformatamount;
        $config['payment']['mpwalletsystem']['walletamount'] = $walletamount;
        $config['payment']['mpwalletsystem']['ajaxurl'] = $ajaxUrl;
        $config['payment']['mpwalletsystem']['walletstatus'] = $walletstatus;
        $config['payment']['mpwalletsystem']['leftamount'] = $leftToPay;
        $config['payment']['mpwalletsystem']['leftinwallet'] = $leftinwallet;
        $config['payment']['mpwalletsystem']['currencysymbol'] = $currencysymbol;
        $config['payment']['mpwalletsystem']['grand_total'] = $grandTotal;
