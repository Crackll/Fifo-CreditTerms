...
namespace Webkul\MpWalletSystem\Model\ResourceModel\Walletcreditrules;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\MpWalletSystem\Model\Walletcreditrules::class,
            \Webkul\MpWalletSystem\Model\ResourceModel\Walletcreditrules::class
        );
