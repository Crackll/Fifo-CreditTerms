...
namespace Webkul\MpWalletSystem\Model\ResourceModel\Wallettransaction;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\MpWalletSystem\Model\Wallettransaction::class,
            \Webkul\MpWalletSystem\Model\ResourceModel\Wallettransaction::class
        );
        $this->addFilterToMap(
            'entity_id',
