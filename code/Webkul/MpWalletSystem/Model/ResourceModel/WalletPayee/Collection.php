...
namespace Webkul\MpWalletSystem\Model\ResourceModel\WalletPayee;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\MpWalletSystem\Model\WalletPayee::class,
            \Webkul\MpWalletSystem\Model\ResourceModel\WalletPayee::class
        );
        $this->addFilterToMap(
            'entity_id',
