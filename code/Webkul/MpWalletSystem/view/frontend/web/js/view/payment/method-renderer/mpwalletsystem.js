...
define(
    ...
    function (ko, $, Component, quote, selectPaymentMethodAction, checkoutData, additionalValidators, totals, defaultTotal, cartCache) {
        'use strict';
        var walletconfig = window.checkoutConfig.payment.mpwalletsystem;
        ...
        return Component.extend(
            {
                defaults: {
                    template: 'Webkul_MpWalletSystem/payment/mpwalletsystem',
                ...
                getData: function () {
                    return {
                        "method": this.myValue()?'mpwalletsystem':null,
                        "po_number": null,
                    ...
                    var ajaxreturn = $.ajax(
                        {
                            ...
                            success:function (content) {
                                ...
                                if (finalRestAmount<=0) {
                                    ...
                                    checkoutData.setSelectedPaymentMethod('mpwalletsystem');
                                } else {
