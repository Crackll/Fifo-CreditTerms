...
define(
    ...
    function ($, Component, ko, checkoutData) {
        ...
        return Component.extend(
            {
                defaults: {
                    template: 'Webkul_MpWalletSystem/wallet-payment',
                ...
                initialize: function () {
                    ...
                    $(document).ready(
                        function () {
                            $('.item-title:has(input[type="radio"][value="mpwalletsystem"][name="payment[method]"])').hide();
                        }
                    );
                    $("body").delegate(
                    ...
                    var ajaxreturn = $.ajax(
                        {
                            ...
                            success:function (content) {
                                ...
                                if (finalRestAmount<=0) {
                                    var walletpayment = $('body').find('input[type="radio"][name="payment[method]"][value="mpwalletsystem"]');
