...
namespace Webkul\MpPurchaseManagement\Model\ResourceModel;
...
class OrderItem extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('wk_mp_purchase_order_item', 'entity_id');
    }
    ...
    {
        return $this->metadataPool->getMetadata(OrderItemInterface::class)->getEntityConnection();
    }
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(OrderItemInterface::class);
