...
use Webkul\Preorder\Helper\Data as PreorderData;
use Webkul\MarketplacePreorder\Helper\Data as MpPreorderData;
    ...
    private function isPreOrder($productId)
    {
        if ($this->moduleManager->isEnabled('Webkul_Preorder')) {
            return $this->objectManager
                ->create(PreorderData::class)
                ->isPreOrder($productId);
        } elseif ($this->moduleManager->isEnabled('Webkul_MarketplacePreorder')) {
            return $this->objectManager
                ->create(MpPreorderData::class)
                ->isPreOrder($productId);
        }
        return false;
    }
